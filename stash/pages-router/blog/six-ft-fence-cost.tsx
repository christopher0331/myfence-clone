              ...
              <div className="space-y-8">
                ...
                <Card className="border-orange-200 bg-orange-50">
                  <CardContent className="p-6">
                    ...
                    <p>
                      <strong>It's always better to invest in the correct fence company the first time, even if that means exploring <Link href="/financing" className="text-primary hover:underline">financing options</Link>.</strong>
                    </p>
                  </CardContent>
                </Card>

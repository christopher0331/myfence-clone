          ...
          <article className="max-w-4xl mx-auto">
            ...
            <section className="mb-10">
              ...
              <p className="mb-4">
                ...
                and our <Link href="/fence-styles/cedar-steel-hybrid-fence" className="text-primary hover:underline">Cedar/Steel Hybrid Fence</Link> systems. 
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="bg-green-100/50 dark:bg-green-900/20 p-4 rounded-lg border border-green-500/30">
                      ...
                      <p className="text-sm mb-2">
                        ...
                        <Link href="/fence-genius" className="text-primary hover:underline font-semibold">Fence Genius</Link> technology, 
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius</Link> technology that stores your exact fence 

          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="text-muted-foreground">• <Link href="/fence-styles/picture-frame-fence" className="text-primary hover:underline">Picture frame style fences</Link></li>
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-1">
              ...
              <h4 className="text-xl font-semibold mb-3">Best For:</h4>
              <ul className="space-y-2 mb-6">
                <li className="text-muted-foreground">• <Link href="/fence-styles/horizontal-lattice-fence" className="text-primary hover:underline">Horizontal lattice fences</Link></li>
                <li className="text-muted-foreground">• <Link href="/fence-styles/craftsman-style-fence" className="text-primary hover:underline">Craftsman style fences</Link></li>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-2">
                <li className="text-muted-foreground">• Premium <Link href="/fence-styles/horizontal-lattice-fence" className="text-primary hover:underline">horizontal lattice</Link> installations</li>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-1">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="text-muted-foreground">• <Link href="/fence-upgrades/lattice-toppers" className="text-primary hover:underline">Lattice topper installations</Link></li>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-2">
                ...
                <li className="text-muted-foreground">• High-end <Link href="/fence-styles/picture-frame-fence" className="text-primary hover:underline">picture frame fences</Link></li>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Pattern-based designs like <Link href="/fence-styles/craftsman-style-fence" className="text-primary hover:underline">craftsman style</Link> and <Link href="/fence-styles/horizontal-lattice-fence" className="text-primary hover:underline">horizontal lattice</Link> often benefit from narrower 1x4 boards.
                  </p>
                </div>
        ...
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg">
              <Link href="/fence-styles">View Fence Styles</Link>
            </Button>
          </div>
        </div>
      </section>

...
CHECKLISTS = [
    {
        ...
        "lines": [
            ...
            "   CWHOA@hoacommunitysolutions.com / HOA Community Solutions / (253) 985-3812",
            "   CC&Rs and bylaws: canterwood.org (ACC application is not a public PDF).",
    ...
    },
    {
        ...
        "lines": [
            ...
            "   Fence is a checkbox on Form B. Read the CRC Fence Guidelines first.",
            ...
            "7. Official forms: somerset98006.org/procedures-and-forms",
    ...
    },
    {
        ...
        "lines": [
            ...
            "   No public fence PDF. Do not use Cedar Downs / Pipe Lake (cedardownsmvhoa.com).",
    ...
    },
    {
        ...
        "lines": [
            ...
            "   Resources: elkrunhoa3and5.com (Div. 3 & 5 CC&Rs, bylaws, declaration).",
            "   There is no public fence-application PDF. Other divisions: ask that board.",
            "2. Request the current CC&Rs and any written-approval path from your division.",
    ...
    },
    {
        ...
        "lines": [
            ...
            "   hoa@tentrails.com / (360) 469-4043 / mygreencondo.net/tentrails/login",
            "   Official forms are in the resident portal, not a public PDF.",
    ...
    },
    {
        ...
        "lines": [
            ...
            "1. Confirm which Bonney Lake association covers your lot (and your phase).",
            "   Falling Water Owners Association: HOA Community Solutions / (253) 985-3812",
            "   Falling Water, Division 4: J&M Management / (253) 848-1947",
            "   Do not use fallingwatershoa.com - that site is Crown Point, Indiana.",
            "2. Request the current ACC application from your manager (not a public PDF).",
            "3. Prepare complete plans, specs, and a site plan showing location on the lot.",
            "4. Ask your manager for the current review timeline before you schedule crews.",

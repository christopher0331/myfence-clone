...
export const WoodenFenceCost2025Content = () => {
          ...
          <Card className="border-primary/20 mb-8">
            <CardContent className="p-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" onClick={() => navigate('/quote')}>Get Instant Quote</Button>
                <Button variant="outline" size="lg" onClick={() => navigate('/contact')}>Schedule Consultation</Button>
              </div>
            </CardContent>
          </Card>
        </article>
...
export default WoodenFenceCost2025Content;

                ...
                <div className="grid md:grid-cols-2 gap-0">
                  <CardContent className="order-2 md:order-1 p-6 md:p-10 flex items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        The exposed grain at the top of the boards can absorb rainwater, potentially leading to rot in the Pacific Northwest's wet climate. This is why we often recommend our <Link href="/fence-styles/picture-frame-fence" className="text-primary hover:underline">Picture Frame</Link> or <Link href="/fence-styles/craftsman-style-fence" className="text-primary hover:underline">Craftsman Style</Link> fences for long-term installations.
                      </p>
                      <p className="text-muted-foreground">

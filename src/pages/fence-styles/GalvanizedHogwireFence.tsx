                ...
                <CardContent className="p-6 md:p-10 flex items-center">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      The 5' Galvanized Hogwire Fence combines the durability of hot-dip galvanized steel with the natural beauty of cedar framing. This mid-height fencing solution uses the same premium cedar frame construction as our popular <Link to="/fence-styles/picture-frame-fence" className="text-primary hover:underline">Picture Frame Fence</Link>, ensuring consistent quality and aesthetic appeal.
                    </p>
                    <p className="text-muted-foreground mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  <CardContent className="p-6 md:p-10 flex items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        If you need maximum privacy and security, our <Link to="/fence-styles/black-hogwire-fence" className="text-primary hover:underline">6' Black Hogwire Fence</Link> offers the same quality construction with additional height. The black powder-coated finish provides a more contemporary look while offering enhanced privacy for backyard areas.
                      </p>

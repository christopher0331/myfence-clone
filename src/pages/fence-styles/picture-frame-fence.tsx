          ...
          <Card className="mb-12">
            ...
            <CardContent className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  Precisely planned layouts using <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius technology</Link> to reduce surprises and change orders.
                </p>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Our proprietary <Link href="/fence-genius" className="text-primary hover:underline">planning software</Link> ensures every panel follows the ground contour perfectly, delivering the exact result you expect.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    {WARRANTY_CONSTANTS.ABOUT_TEXT}, we take pride in delivering exceptional results with <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius precision planning</Link>.
                  </p>

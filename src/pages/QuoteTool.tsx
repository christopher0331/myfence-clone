  ...
  return (
    <main>
      ...
      <section className="container py-10">
        ...
        <Tabs defaultValue="online" className="mt-8">
          <TabsList>
            <TabsTrigger value="online">Instant Online Quote</TabsTrigger>
            <TabsTrigger value="estimator">Quick Estimator</TabsTrigger>
          </TabsList>

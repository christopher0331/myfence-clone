          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                A rot board is a pressure-treated 2x4 installed at the bottom of your fence, creating a sacrificial barrier 
                between the ground and your cedar fence boards. This innovative solution allows us to bring your fence much 
                closer to the ground without risking damage to the cedar portion of your fence.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We coined the name "rot board" because this pressure-treated lumber is specifically designed to take the 
                abuse from soil contact — something cedar should never be exposed to, as it dramatically accelerates rot.
              </p>
        ...
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg">
              <Link to="/fence-styles">Explore Other Fence Styles</Link>
            </Button>
          </div>
        </div>
      </section>

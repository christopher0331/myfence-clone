  ...
  const structuredData = {
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Referral Program", "item": `${SITE_CONFIG.url}/referrals` }
      ]
    }
  };
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-16 md:py-24">
          <div className="container text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Refer a friend to MyFence.com and you <strong>both</strong> receive a <span className="text-primary font-bold">$150 Amazon Gift Card</span> after their fence is installed.
            </p>
            <a href="#referral-form" className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary/90 transition-colors">
              Submit a Referral
            </a>
          </div>
        </section>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-center text-muted-foreground mb-10">
                Fill out the form below and we'll reach out to your friend. Once their fence project is complete, you'll both receive your $150 Amazon Gift Card!
              </p>
          ...
          <div className="container max-w-3xl">
            ...
            <div className="mt-12 p-6 bg-muted/50 rounded-lg">
              ...
              <ul className="text-sm text-muted-foreground space-y-2">
                <li>• Gift card is awarded after fence installation is complete and payment is received in full</li>
                ...
                <li>• Gift cards are typically delivered within 2-4 weeks of project completion</li>
                <li>• Program details subject to change; current and past customers in good standing are eligible to refer</li>
              </ul>
            </div>
          </div>
        </section>

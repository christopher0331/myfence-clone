  ...
  <article className="space-y-12">
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Every Tukwila cedar installation uses pressure-treated posts set in properly-drained concrete, stainless steel fasteners rated for high humidity, and construction techniques developed over decades of river valley work. For properties closest to waterways, our <Link to="/fence-upgrades/post-on-pipe" className="text-primary underline decoration-2 underline-offset-2">Post-on-Pipe system</Link> eliminates ground contact entirely—the single most effective way to prevent post rot in Tukwila's moisture-rich soil.
        </p>
      </div>
    ...
    <section className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Plenty of Tukwila homeowners finance their fences—it's a practical way to handle home improvements. <Link to="/financing" className="text-primary underline decoration-2 underline-offset-2">See current rates and terms</Link>.
          </p>
        </div>

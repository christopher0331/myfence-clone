...
const BonneyLakeArticle = () => (
  <article className="space-y-12">
    ...
    <section className="space-y-4">
      ...
      <p className="text-muted-foreground leading-relaxed">
        For the most current information on Bonney Lake fence requirements, contact the <a href="https://www.ci.bonney-lake.wa.us/Government/Governance/Council_Standing_Committees" target="_blank" rel="noopener noreferrer" className="text-primary underline decoration-2 underline-offset-2">City of Bonney Lake Community Development</a> at <a href="tel:253-447-4356" className="text-primary underline decoration-2 underline-offset-2">253-447-4356</a> or visit their offices at 9002 Main Street E. You can also access the <a href="https://www.ci.bonney-lake.wa.us/Government/Departments/Public_Services/Code_Enforcement" target="_blank" rel="noopener noreferrer" className="text-primary underline decoration-2 underline-offset-2">Bonney Lake Code Enforcement</a> page for complete fence regulations.
      </p>
    </section>

        ...
        <Card className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Industry-leading {WARRANTY_CONSTANTS.YEARS}-year craftsmanship warranty and up to 20-year materials warranty protect your investment long-term.
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Premium materials include manufacturer warranties up to 20 years, protecting against defects in wood and metal components.
              </p>
              <ul className="space-y-1 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0 mt-0.5" />

              ...
              <div className="glass-frame">
                <AspectRatio ratio={1}>
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-background/30 backdrop-blur-sm text-foreground">
                      <h3 className="font-semibold text-center">Picture Frame Fence</h3>
                      <Button size="sm" onClick={() => setIsQuoteModalOpen(true)} aria-label="Click here for Free Estimate for Picture Frame Fence">Click here for Free Estimate</Button>
                    </div>
                  </div>
                </AspectRatio>
              </div>
              ...
              <div className="glass-frame">
                <AspectRatio ratio={1}>
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-background/30 backdrop-blur-sm text-foreground">
                      <h3 className="font-semibold text-center">3 Rail Picture Frame Fence</h3>
                      <Button size="sm" onClick={() => setIsQuoteModalOpen(true)} aria-label="Click here for Free Estimate for 3 Rail Picture Frame Fence">Click here for Free Estimate</Button>
                    </div>
                  </div>
                </AspectRatio>
              </div>
              ...
              <div className="glass-frame">
                <AspectRatio ratio={1}>
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-background/30 backdrop-blur-sm text-foreground">
                      <h3 className="font-semibold text-center">Horizontal Lattice Fence</h3>
                      <Button size="sm" onClick={() => setIsQuoteModalOpen(true)} aria-label="Click here for Free Estimate for Horizontal Lattice Fence">Click here for Free Estimate</Button>
                    </div>
                  </div>
                </AspectRatio>
              </div>

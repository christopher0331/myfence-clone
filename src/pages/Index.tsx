        ...
        <div className="grid md:grid-cols-[1fr_1fr] items-stretch rounded-xl shadow-elevated overflow-hidden">
          <div className="bg-foreground text-background p-6 md:p-10">
            ...
            <div className="mt-5 relative">
              ...
              <span className="absolute top-1/2 -translate-y-1/2 right-4 sm:right-8 text-4xl sm:text-5xl animate-pulse -rotate-45 pointer-events-none" aria-hidden="true">👆</span>
            </div>
          </div>

...
const styles = [
  ...
  { img: "/lovable-uploads/cedar-aluminum-hybrid-fence-hero.png", title: "Cedar/Steel Hybrid Fence", desc: "26 gauge corrugated steel panels with HDP NoFade™ paint and cedar framing. Zero maintenance, ultimate privacy. Starting at $80/LF.", badge: "Premium Investment", link: "/fence-styles/cedar-aluminum-hybrid-fence" },
              ...
              <CardContent className="flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4">
                  ...
                  {a.title === "Soil Haul-Away" && (
                    <Button asChild className="w-full">
                      <Link to="/fence-upgrades/soil-haul-away">

    ...
    <main>
      ...
      <section className="relative py-10">
        ...
        <div className="container relative z-10">
          ...
          <p className="max-w-2xl text-background/90">Use our online tool to get real-time pricing for your fence project. After your quote, we'll use <Link href="/fence-genius" className="underline hover:no-underline text-background">Fence Genius technology</Link> to ensure perfect installation.</p>

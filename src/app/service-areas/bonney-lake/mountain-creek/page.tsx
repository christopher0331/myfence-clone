...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://myfence.com/service-areas/bonney-lake/mountain-creek" },
};

export default function MountainCreekServiceAreaPage() {
  return <MountainCreekPage canonical="https://myfence.com/service-areas/bonney-lake/mountain-creek" />;
}

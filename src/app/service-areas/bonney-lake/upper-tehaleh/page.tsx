...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://myfence.com/service-areas/bonney-lake/upper-tehaleh",
  },
};

export default function UpperTehalehPage() {
  return <TehalehPage isUpper={true} canonical="https://myfence.com/service-areas/bonney-lake/upper-tehaleh" />;
}

...
export const blogArticles: BlogArticle[] = [
  ...
  // },
  {
    ...
    description: "See how MyFence.com builds cedar gates with kiln-dried 2x4 frames, compression-fit diagonal braces, and 6-8 inch lag screws. Self-closing hardware is an optional upgrade, not standard.",

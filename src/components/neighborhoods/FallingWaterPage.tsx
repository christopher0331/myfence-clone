  ...
  return (
    <>
      ...
      <main className="min-h-screen">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
              <div className="text-center lg:text-left">
                <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                  ...
                  <span className="text-lg text-muted-foreground">Serving Falling Water</span>
                </div>
              ...
              <div className="w-full rounded-lg overflow-hidden shadow-lg">
                <GoogleBusinessMap city="Falling Water" state="Washington" radiusMiles={2} zoom={14} showBusinessInfo={true} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold">Falling Water-Specific Considerations</h2>
        ...
        <VirtualQuoteTool fenceStyleName="Falling Water fence" />

        ...
        <section className="py-16 bg-muted/50">
          <div className="container">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-8">
                We install fences throughout Kirkland. If you&apos;re near Juanita, we also serve Kingsgate east of I-405, Downtown Kirkland, Finn Hill, Bridle Trails, Market, and Moss Bay.
              </p>

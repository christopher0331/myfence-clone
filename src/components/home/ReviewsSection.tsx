...
export const ReviewsSection = ({ reviewsRef }: ReviewsSectionProps) => {
  return (
    <section className="container py-12 md:py-16" aria-labelledby="reviews-heading">
      ...
      <p className="text-muted-foreground mt-2 max-w-2xl">Choosing a Seattle fence builder is an investment—make it with the father & son team that builds it right the first time. If you're searching for a fence company near me, our customers agree you're in the right place.</p>

...
const styles = [
  ...
  { img: "/lovable-uploads/4b59fcdd-ded2-42f1-bb1c-9eb01268a427.png", title: "Modified Picture Frame Fence", desc: "Top cap and side trim without a bottom board — HOA-approved and more economical. Stainless steel fasteners required.", badge: "HOA Friendly", link: "/fence-styles/modified-picture-frame-fence" },
  ...
  { img: "https://ik.imagekit.io/xft9mcl5v/service-area-photos/Maple-Valley/Maple-Woods-Shadow-Box-Fence-1.webp", title: "Shadow Box Fence", desc: "The 'good neighbor' fence — alternating cedar boards make both sides look identical and finished, with airflow between staggered panels.", badge: "Good Neighbor", link: "/fence-styles/shadow-box-fence" },
  ...
  { img: "https://ik.imagekit.io/xft9mcl5v/service-area-photos/Maple-Valley/Daybreak-at-River-Ridge-Steel-Cedar-Hybrid-4.webp", title: "Cedar/Steel Hybrid Fence", desc: "26 gauge corrugated steel panels with HDP NoFade™ paint and cedar framing. Zero maintenance, ultimate privacy. Starting at $80/LF.", badge: "Premium Investment", link: "/fence-styles/cedar-steel-hybrid-fence" },
  { img: "https://ik.imagekit.io/xft9mcl5v/Webp_Converter_Folder_webp/test_input_Converted/IMG_4554.webp?updatedAt=1766269883425", title: "5' Galvanized Hogwire Fence", desc: "Strong galvanized wire panels for durable visibility and style.", link: "/fence-styles/galvanized-hogwire-fence" },

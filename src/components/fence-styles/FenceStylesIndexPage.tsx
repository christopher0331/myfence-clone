...
const styles = [
  ...
  { img: "https://ik.imagekit.io/xft9mcl5v/hero-images/Shadow-Box-Hero.webp", title: "Shadow Box Fence", desc: "The 'good neighbor' fence — alternating cedar boards make both sides look identical and finished, with airflow between staggered panels.", badge: "Good Neighbor", link: "/fence-styles/shadow-box-fence" },

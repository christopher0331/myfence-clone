              ...
              <div className="mt-4 grid md:grid-cols-2 gap-6 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-4">
                    <Button asChild>
                      <Link href="/quote" aria-label="Start your craftsman style fence quote">Start Your Quote</Link>
                    </Button>
                    <Button asChild variant="secondary">
                      <Link href="/contact" aria-label="Contact MyFence.com">Contact Us</Link>
                    </Button>
                  </div>
                </div>
                ...
                <CardContent className="p-6 md:p-10 flex items-center">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Built with the same premium cedar frame construction as our popular <Link href="/fence-styles/picture-frame-fence" className="text-primary hover:underline">Picture Frame Fence</Link>, but with added architectural interest.
                    </p>
                  </div>
                </CardContent>
              </div>

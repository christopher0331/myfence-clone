  ...
  return (
    <>
      <Seo
        ...
        image="/lovable-uploads/3ft-black-hogwire-og.webp"
        ...
        <nav className="bg-background pt-4 pb-2 border-b">
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-muted-foreground">/</span>
              <span className="text-foreground font-medium">3' Black Hogwire Fence</span>
            </div>
          </div>
        </nav>
            ...
            <div className="space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    Like our <Link href="/fence-styles/picture-frame-fence" className="text-primary hover:underline">Picture Frame Fence</Link>, this design features cedar-framed panels with powder-coated black hogwire. We recommend having the cedar components professionally stained before assembly for optimal longevity and appearance.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-primary rounded-full"></div>

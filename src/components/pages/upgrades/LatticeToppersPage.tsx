...
const LatticeToppersPage = () => {
  ...
  const serviceStructuredData = {
    ...
    description:
      "Add 2-foot lattice toppers to your 6-foot fence for extra height, privacy, and style while remaining code compliant in Washington State.",
    provider: {
      "@type": "LocalBusiness",
      name: "MyFence.com",
      address: {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="container pt-8 pb-3 md:py-16">
        ...
        <div className="max-w-4xl mx-auto">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-lg">
                In Washington State, building codes allow for 6-foot solid privacy fences but generally prohibit 8-foot solid
                privacy fences. The solution? Add a 2-foot lattice topper to your 6-foot solid fence for the extra height you
                need while maintaining code compliance.
              </p>
              <p className="text-lg">
                A lattice topper features approximately 50% airflow, which satisfies code requirements while adding extra privacy,
                style, and a beautiful perimeter to your backyard. It's the perfect balance between height, aesthetics, and
                compliance.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <p>
                  Get the height you want without violating local building codes. The 50% airflow design keeps you compliant
                  while adding 2 feet to your fence.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Gain an extra 2 feet of privacy screening while maintaining proper airflow. Perfect for blocking views from
                  neighboring second-story windows.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Add visual interest and elegance to your fence with horizontal, vertical, or custom lattice patterns that
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Built with 4x6x12' posts and 36" deep footings to withstand Pacific Northwest wind loads while maintaining
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground ml-8">
                    We use full 4x6x12' fence posts for lattice topper installations. These larger posts provide the structural
                    support needed for 8-foot total fence height and ensure long-term stability.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground ml-8">
                    Large post footings are poured approximately 36 inches deep to withstand the increased wind loads that come
                    with additional fence height. This ensures your fence remains stable through Pacific Northwest storms.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground ml-8">
                    The lattice section features approximately 50% airflow spacing, which is the recommended standard for code
                    compliance and proper wind management while still providing effective privacy screening.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Our most popular option. Clean horizontal lines that create a modern, contemporary look while maximizing
                  privacy.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Common questions about lattice toppers and code compliance</CardDescription>
            </CardHeader>
            <CardContent>
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-muted-foreground">
                    Yes! Washington State building codes generally allow 6-foot solid privacy fences and prohibit 8-foot solid
                    fences. Adding a 2-foot lattice topper with approximately 50% airflow satisfies code requirements while
                    giving you 8 feet of total height. The lattice design ensures proper airflow, which is the key requirement
                    for code compliance.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-left">How much do 2-foot lattice toppers cost?</AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    Lattice toppers typically add $15-25 per linear foot to your fence installation cost. The total cost
                    depends on the lattice pattern chosen (horizontal, vertical, or custom), post requirements, and project size.
                    Contact us for a free quote tailored to your specific project.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                  <AccordionTrigger className="text-left">How long does it take to install lattice toppers?</AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    Installation time depends on project size, but lattice toppers typically add 1-2 days to a standard fence
                    installation. This includes time for installing larger 4x6 posts, pouring deeper 36-inch footings, and
                    constructing the lattice panels. We'll provide an accurate timeline during your free consultation.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent className="text-muted-foreground">
                    Yes, we recommend full 4x6x12' fence posts for lattice topper installations. These larger posts provide the
                    structural support needed for 8-foot total height and withstand increased wind loads. We also pour deeper
                    footings (approximately 36 inches) to ensure long-term stability.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-5">
                  <AccordionTrigger className="text-left">What lattice patterns are available?</AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    Our most popular options include horizontal lattice strips, vertical alternating boards, and custom
                    patterns. The horizontal style is our fan favorite for its modern, clean appearance. We can also create
                    custom lattice designs to match your property's aesthetic. All patterns maintain approximately 50% airflow
                    for code compliance.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-6">
                  <AccordionTrigger className="text-left">Can lattice toppers be added to existing fences?</AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                    In some cases, yes. However, existing fences must have posts strong enough to support the additional height
                    and wind load. We'll need to inspect your current fence structure to determine if it can safely support a
                    lattice topper or if post reinforcement is needed. Contact us for a free assessment.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </CardContent>
      ...
      <section className="container py-12 md:py-16">
        <Card className="max-w-3xl mx-auto text-center bg-primary/5 border-primary/20">
          <CardContent className="pt-8 pb-8">
            <h2 className="text-3xl font-bold mb-4">Ready for Code-Compliant 8-Foot Fences?</h2>

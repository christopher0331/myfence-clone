...
const TrellisSystemsPage = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-28 md:pt-36">
        <div
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground">6x6x10' premium cedar fence posts provide robust structural support</p>
                </div>
                <div>
                  <h3 className="font-semibold text-lg mb-2">Runners</h3>
                  <p className="text-muted-foreground">2x8 cedar runners form the horizontal framework</p>
                </div>
                <div>
                  <h3 className="font-semibold text-lg mb-2">Slats</h3>
                  <p className="text-muted-foreground">Cedar 2x2 slats create the decorative pattern</p>
                </div>
                <div>

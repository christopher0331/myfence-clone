...
const FenceGeniusPage = () => {
  const structuredData = {
    ...
    description:
      "Learn about Fence Genius, our patented technology that removes guesswork from fence construction and guarantees algorithmically perfect fences.",
    url: "https://myfence.com/fence-genius",
    mainEntity: {
      "@type": "TechArticle",
      headline: "Fence Genius: Revolutionary Fence Construction Technology",
      description:
        "Patented technology that ensures perfect fence installation through precise measurements and algorithmic calculations.",
      author: {
        "@type": "Organization",
        name: "MyFence.com",
      },
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-2 md:gap-4 text-background/80 flex-wrap px-4">
              <span className="px-3 py-1.5 md:px-4 md:py-2 bg-primary/20 rounded-full text-xs md:text-sm font-medium">
                Patented
              </span>
              <span className="px-3 py-1.5 md:px-4 md:py-2 bg-primary/20 rounded-full text-xs md:text-sm font-medium">
                Perfect Results
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <p className="text-lg text-muted-foreground italic">
                "When you hire a traditional fence contractor, you really have no idea what you're going to get from
                them."
              </p>
            </div>
          </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    <div className="bg-primary text-primary-foreground rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center font-bold text-lg md:text-xl mb-4">
                      1
                    </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Software calculates the perfect build, maximizing material yield.
                      </p>
                      <img
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground italic">
                        Terrain adaptation and contour calculations
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Choose smoothed or stepped top with dynamic bottom adjustments.
                      </p>
                      <img
                      ...
                      />
                      <p className="text-xs md:text-sm text-muted-foreground italic">
                        Flat smoothed vs stepped configurations
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Detailed PDF showing exactly what to expect. Changes are easy.
                      </p>
                      <img
                      ...
                      />
                      <p className="text-xs md:text-sm text-muted-foreground italic">
                        Aerial view and 3D rendering for approval
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                        Custom manufactured fence system delivered ready for installation.
                      </p>
                      <img
                      ...
                      />
                      <p className="text-xs md:text-sm text-muted-foreground italic">
                        Manufactured to exact specs, ready to install
                      </p>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              <Link href="/fence-styles/craftsman-style-fence" className="block hover:opacity-80 transition-opacity">
              ...
              <Link href="/fence-styles/picture-frame-fence" className="block hover:opacity-80 transition-opacity">
                <Card className="overflow-hidden">
                  <img
              ...
              <Link href="/fence-styles/solid-board-fence" className="block hover:opacity-80 transition-opacity">
                <Card className="overflow-hidden">
                  <img
              ...
              <Link href="/fence-styles/3-rail-picture-frame-fence" className="block hover:opacity-80 transition-opacity">
                <Card className="overflow-hidden">
                  <img
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Eric Knudsen and Andrew Knudsen have spearheaded the development of this new patented technology, and are
              bringing it to the industry at large through their fence contracting company, MyFence.com.
            </p>
            <div className="bg-primary/10 p-8 rounded-lg">
              ...
              <div className="bg-background/50 p-4 rounded-lg">
                <p className="text-sm text-muted-foreground mb-2">
                  <strong>Pro Tip:</strong> Pair Fence Genius with
                  <Link href="/fence-posts/steel-posts" className="text-primary hover:underline">
                    4x4 steel fence posts
                  </Link>
                  for maximum long-term value. When it's time to refresh your fence, your measurements stay on
                  file—saving ~40% on panel replacement.
                </p>
                <Link
...
export default FenceGeniusPage;

...
const riddles = [
  ...
  {
    question:
      "I'm made of wood that's aromatic and red, resistant to weather and bugs that are dread. What wood am I?",
    answers: ["cedar"],
  ...
  {
    question:
      "I'm clear and protective, I make wood shine bright, keeping the elements away day and night. What am I?",
  ...
  {
    question:
      "I'm the space between pickets, not too wide or narrow, I let light pass through like a wooden arrow. What am I?",
    answers: ["gap"],
    hint: "The opening between fence boards",
  },
  {
    question:
      "I'm dug in the earth before posts are placed, making sure your fence line is properly spaced. What am I?",
    answers: ["hole"],
    hint: "The excavation for fence post installation",
  },
  {
    question:
      "I'm slanted and topped with caps so neat, keeping water away from where posts meet. What am I?",
    answers: ["post cap", "cap"],
    hint: "The protective top piece on fence posts",
  },
  {
    question:
      "I swing both ways and latch with a click, keeping your yard secure with just one quick trick. What am I?",
    answers: ["latch"],
...
const DiscountsPage = () => {
  ...
  useEffect(() => {
    ...
    const lastPlayDate = typeof window !== "undefined" ? localStorage.getItem("lastDiscountPlayDate") : null;
  ...
  const startWheelClicking = () => {
    ...
    const scheduleClick = () => {
      ...
      setClickTimeout(timeout as unknown as NodeJS.Timeout);
    };
  ...
  const checkAnswer = () => {
    ...
    const isAnswerCorrect = currentRiddle.answers.some(
  ...
  const spinWheel = () => {
    ...
    window.setTimeout(() => {
      ...
      if (lastPlayDate === todayString) {
        setShouldClick(false);
        if (clickTimeout) {
          window.clearTimeout(clickTimeout as unknown as number);
      ...
      window.setTimeout(
        () => burstFirework(window.innerWidth / 3, window.innerWidth / 3),
        200,
      );
      window.setTimeout(
        () => burstFirework((window.innerWidth / 3) * 2, window.innerHeight / 3),
        400,
      );
  ...
  const onSubmitAlreadyPlayed = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 pt-24 pb-12">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-foreground mb-4">Daily Discount Challenge</h1>
            ...
            <CardContent className="space-y-6">
              ...
              {isCorrect && !hasPlayedToday && (
                <div className="text-center space-y-6">
                  <div className="text-2xl text-green-600 font-semibold">🎉 Correct! Now spin the wheel! 🎉</div>
                  ...
                  <div className="flex justify-center">
                    <div className="relative">
                      ...
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4">
                        <div className="w-0 h-0 border-l-4 border-r-4 border-b-8 border-l-transparent border-r-transparent border-b-red-600" />
                      </div>
                    </div>
                  </div>
              ...
              {isCorrect && hasPlayedToday && (
                <div className="text-center space-y-4">
                  <div className="text-2xl text-green-600 font-semibold">🎉 Correct Answer! 🎉</div>
                  <div className="p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div className="space-y-3">
                      <Button onClick={() => setShowAlreadyPlayedForm(true)} className="w-full">
                        Get a Free Quote
                      </Button>
                      <Button
                        variant="outline"
            ...
            <DialogContent className="max-w-lg">
              ...
              <div className="space-y-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <p className="font-semibold text-green-800">You won: {selectedDiscount}</p>
                </div>

...
const PreStainingPage = () => {
  const structuredData = {
    ...
    description:
      "Discover why pre-staining cedar fence materials before installation provides superior protection compared to traditional on-site staining. Complete coverage including hidden areas.",
    author: {
      "@type": "Organization",
      name: "MyFence.com",
    },
            ...
            <div className="space-y-6">
              <details className="group bg-background p-6 rounded-lg shadow">
                ...
                <div className="mt-4 text-muted-foreground">
                  <p>
                    Pre-staining typically adds 15-25% to the material cost, but this investment pays for itself through
                    extended fence life and reduced maintenance needs. When you factor in the superior protection and longer
                    intervals between re-staining, it's actually more economical long-term.
                  </p>
                </div>
              </details>
              ...
              <details className="group bg-background p-6 rounded-lg shadow">
                ...
                <div className="mt-4 text-muted-foreground">
                  <p>
                    We plan for pre-staining by purchasing and processing materials well in advance. While the staining and
                    curing process takes additional time, we coordinate this with your project schedule so there's minimal impact
                    on your installation timeline.
                  </p>
                </div>
              </details>
              ...
              <details className="group bg-background p-6 rounded-lg shadow">
                ...
                <div className="mt-4 text-muted-foreground">
                  <p>
                    Absolutely! We work with premium stain manufacturers and can accommodate virtually any color preference.
                    We'll provide color samples and recommendations based on your home's style and the local climate conditions.
                  </p>
                </div>
              </details>
              ...
              <details className="group bg-background p-6 rounded-lg shadow">
                ...
                <div className="mt-4 text-muted-foreground">
                  <p>
                    Our experienced crew takes extra care with pre-stained materials. In the rare case of damage, we keep
                    touch-up stain on hand and can address minor scratches immediately. For major damage, we have backup
                    pre-stained pieces ready.
                  </p>
                </div>
              </details>
              ...
              <details className="group bg-background p-6 rounded-lg shadow">
                ...
                <div className="mt-4 text-muted-foreground">
                  <p>
                    Pre-staining works excellent with all our fence styles. It's particularly beneficial for styles with
                    tight joints like horizontal fences, lattice work, or picture frame designs where traditional staining
                    can't reach many surfaces.
                  </p>
                </div>
              </details>
            </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="px-8">
                <Link href="/quote">Get Pre-Staining Quote</Link>
              </Button>
...
export default PreStainingPage;

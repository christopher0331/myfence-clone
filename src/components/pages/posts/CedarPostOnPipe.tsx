            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 text-amber-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <strong>Extreme Wind Exposure</strong> — For hilltops, open fields, or coastal areas with severe wind, <Link href="/fence-posts/steel-posts" className="text-primary hover:underline">4x4 Steel Posts</Link> provide the most robust option.
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Button asChild variant="outline" className="h-auto py-4">
              <Link href="/fence-posts/4-125-posts" className="flex flex-col items-start text-left">

    ...
    <section className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Many Kirkland homeowners finance their fence alongside other waterfront improvements. <Link href="/financing" className="text-primary underline decoration-2 underline-offset-2">See full financing details and apply</Link>.
          </p>
        </div>

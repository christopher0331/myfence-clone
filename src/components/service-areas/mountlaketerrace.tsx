  ...
  <article className="space-y-12">
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Post rot claims most fences in Mountlake Terrace before the boards ever fail. Our standard installation sets pressure-treated posts in concrete with the top sloped away from the wood — a small detail that prevents water pooling. For properties along Ballinger Creek or backing onto park areas, we recommend our <Link href="/fence-upgrades/post-on-pipe" className="text-primary underline decoration-2 underline-offset-2">Post-on-Pipe system</Link> that keeps cedar completely out of the ground. The extra cost pays off when you're not replacing posts every 12-15 years.
        </p>
      </div>
    ...
    <section className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Plenty of Gateway and Cedar Terrace homeowners finance their fences — it's a practical way to handle an unexpected expense or upgrade sooner than planned. <Link href="/financing" className="text-primary underline decoration-2 underline-offset-2">See current rates and terms</Link>.
          </p>
        </div>
    ...
    <section className="space-y-4">
      ...
      <Card className="p-6 space-y-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Properties within a mile of Lake Ballinger experience 10-15% higher humidity than surrounding areas. This constant moisture accelerates wood rot in standard installations. We counter this with pressure-treated posts set in sloped concrete, stainless steel fasteners, and cedar graded for wet climates. Our <Link href="/fence-upgrades/post-on-pipe" className="text-primary underline decoration-2 underline-offset-2">Post-on-Pipe upgrade</Link> eliminates ground contact entirely for lakeside properties.
          </p>
        </div>
        <div>

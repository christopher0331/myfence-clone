    ...
    <div className="prose prose-lg max-w-none">
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-2 mb-6">
          <li className="flex items-start">
            <CheckCircle2 className="w-5 h-5 mr-2 text-primary flex-shrink-0 mt-1" />
            <span><strong><Link href="/fence-styles/solid-board-fence" className="text-primary hover:underline">Cedar Privacy Fences</Link>:</strong> Full privacy with premium moisture-resistant treatments for waterfront durability</span>
          </li>
          <li className="flex items-start">
            <CheckCircle2 className="w-5 h-5 mr-2 text-primary flex-shrink-0 mt-1" />
            <span><strong><Link href="/fence-styles/horizontal-fence" className="text-primary hover:underline">Horizontal Cedar Fencing</Link>:</strong> View-friendly modern designs preserving lake sight lines while providing privacy</span>
          </li>
          <li className="flex items-start">
            <CheckCircle2 className="w-5 h-5 mr-2 text-primary flex-shrink-0 mt-1" />
            <span><strong><Link href="/fence-styles/black-hogwire-fence" className="text-primary hover:underline">Hogwire Fence Systems</Link>:</strong> Unobstructed lake views with durable cedar frames and corrosion-resistant wire panels</span>
          </li>
        </ul>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg mb-4">
          <Link href="/financing" className="text-primary hover:underline font-semibold">

    ...
    <section className="space-y-4">
      ...
      <Card className="p-6 space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            <a href="https://apps.leg.wa.gov/RCW/default.aspx?cite=16.60.020" target="_blank" rel="noopener noreferrer" className="text-primary underline decoration-2 underline-offset-2">Washington State law (RCW 16.60.020)</a> establishes clear rules for shared fence costs. If your fence is on the property line and serves as a partition between properties, your neighbor may be required to pay half the cost. We recommend discussing plans early and providing professional documentation. Learn more about <a href="https://myfence.com/blog/neighbor-fence-cost-split" className="text-primary underline decoration-2 underline-offset-2">splitting fence costs with neighbors</a>.
          </p>
        </div>
        <div>
  ...
  return (
    ...
    <ServiceAreaTemplate 
      ...
      neighborhoods={[
        ...
        {
          name: "Bridle Trails",
          description: "Equestrian estates on 1+ acre lots requiring specialized post-and-rail designs and compliance with horse-property fencing codes. Click to learn more →",
          link: "/service-areas/bellevue/bridle-trails"
        },
        {
          name: "Somerset",

  ...
  <article className="space-y-12">
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Every Gig Harbor cedar fence incorporates marine-grade stainless steel fasteners specifically engineered for saltwater corrosion resistance. We use triple-sealed joinery systems and premium pressure-treated posts designed to withstand Gig Harbor's persistent marine moisture. Our optional <Link href="/fence-upgrades/post-on-pipe" className="text-primary underline decoration-2 underline-offset-2">Post-on-Pipe upgrade</Link> extends fence lifespan by decades, eliminating ground contact and preventing wood rot at the post base—critical for maritime installations.
        </p>
      </div>
    ...
    <section className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Apply in minutes and receive quick decisions. Our financing lets you install your dream fence now and pay over time with manageable monthly payments. <Link href="/financing" className="text-primary underline decoration-2 underline-offset-2">Learn more about Wisetack financing options</Link>.
          </p>
        </div>

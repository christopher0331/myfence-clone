          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-8 items-start">
            <div>
              <p className="text-muted-foreground">
                Father & son owned and operated. We build with our proprietary <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius technology</Link> for superior build quality and unmatched customer clarity from estimate to final walkthrough.
              </p>

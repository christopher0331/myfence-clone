  ...
  return (
    <main>
      ...
      <section id="fence-styles" className="container py-10">
        ...
        <p className="text-muted-foreground max-w-2xl">We design and build fences that fit your property, lifestyle, and budget — backed by our exclusive <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius technology</Link> for perfect planning.</p>
          ...
          {styles.map((s) => (
            <Link key={s.title} href={s.link} className="group">
              <Card className="overflow-hidden hover:shadow-elevated transition-shadow h-full group-hover:border-primary/50">
                ...
                <CardContent>
                  <AspectRatio ratio={1}>
                    <OptimizedImage src={s.img} alt={`${s.title} fence in Seattle by MyFence.com`} className="w-full h-full object-cover rounded-md group-hover:scale-105 transition-transform duration-300" />
                  </AspectRatio>
              ...
              <CardContent className="flex flex-col flex-1">
                ...
                {p.title === '3.5" x 3.5" Fence Posts' && (
                  <Button asChild className="mt-auto w-full" variant="destructive">
                    <Link href="/fence-posts/3-5-posts">
                ...
                {p.title === '4.125" x 4.125" x 9\' Posts' && (
                  <Button asChild className="mt-auto w-full">
                    <Link href="/fence-posts/4-125-posts">
                      Learn More
                    </Link>
                  </Button>
                )}
                ...
                {p.title === "4x4 Steel Posts" && (
                  <Button asChild className="mt-auto w-full">
                    <Link href="/fence-posts/steel-posts">
                ...
                {p.title === "Post on Pipe" && (
                  <Button asChild className="mt-auto w-full">
                    <Link href="/fence-upgrades/post-on-pipe">
                ...
                {p.title === "Cedar Post on Pipe" && (
                  <Button asChild className="mt-auto w-full">
                    <Link href="/fence-posts/cedar-post-on-pipe">
                ...
                <div className="mt-auto pt-4">
                  {a.title === "Upgrade to 4\" Screws" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/exterior-screws">
                  ...
                  {a.title === "Clear Cedar Fence Boards Upgrade" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/clear-cedar">
                  ...
                  {a.title === "Board on Board Style" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/board-on-board">
                  ...
                  {a.title === "2x4 Rot Board" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/rot-board">
                  ...
                  {a.title === "Pre-Staining" && (
                    <Button asChild className="w-full">
                      <Link href="/pre-staining-cedar-fence">
                  ...
                  {a.title === "Soil Haul-Away" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/soil-haul-away">
                        Learn More About Soil Haul-Away
                      </Link>
                    </Button>
                  )}
                  {a.title === "Trellis Systems" && (
                    <Button asChild className="w-full">
                      <Link href="/fence-upgrades/trellis-systems">

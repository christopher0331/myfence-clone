  ...
  return (
    <main>
      ...
      <section className="container py-10">
        ...
        <p className="text-muted-foreground max-w-2xl">A look at our craftsmanship across Seattle neighborhoods. Every project is precisely planned using <Link href="/fence-genius" className="text-primary hover:underline">Fence Genius technology</Link> and executed to perfection.</p>
